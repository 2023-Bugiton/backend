...
from chats.models import RoomJoin
from chats.services.chat_room_service import get_an_chat_room_list, get_chat_room_user, confirm_user_chat_room_join, \
    creat_an_chat_room, creat_an_room_join
from chats.services.message_service import get_an_message_list
...
def chat_view(request: HttpRequest) -> HttpResponse:
    ...
    if user:
        ...
        return render(request, "chats/chat.html", {'chat_info': chat_info})
    # 사용자가 없으면 로그인화면
    else:
